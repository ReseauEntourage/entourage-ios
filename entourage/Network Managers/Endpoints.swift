...
let kAPIGetDefaultNeighborhoods = "users/me/neighborhoods/default?token=%@"
...
let kAPIGetNationalNeighborhoods = "neighborhoods/national?token=%@"
...
let kAPIEventSensibilisation = "outings/webinar?token=%@"
let kAPIEventWelcome = "outings/firsts_steps?token=%@"
let kAPIEventPapotages = "outings/papotages?token=%@"
...
let kAPIContribCreate = "contributions?token=%@&auto_post_at_create=%@"
let kAPISolicitationCreate = "solicitations?token=%@&auto_post_at_create=%@"
let kAPIContribUpdate = "contributions/%@?token=%@&auto_post_at_create=%@"
let kAPISolicitationUpdate = "solicitations/%@?token=%@&auto_post_at_create=%@"
...
let AMBASSADOR_TOOLKIT_URL = "https://drive.google.com/drive/folders/1H9_G4I7zgcJ7Y4DtZDws3coFPsoVnLLm"
let AMBASSADOR_WHATSAPP_URL = "https://chat.whatsapp.com/IvpPJZS0aAKIJKVXmMRTr0"
let AMBASSADOR_CHARTER_URL = "https://app.entourage.social/chart-event"
