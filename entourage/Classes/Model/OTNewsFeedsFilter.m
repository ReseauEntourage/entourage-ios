...
- (instancetype)init {
    ...
    if(self) {
        ...
        if(savedFilter) {
            ...
            self.showDemandeSocial = self.isPro;
            self.showDemandeEvent = self.isPro;
            self.showDemandeHelp = self.isPro;
            self.showDemandeResource = self.isPro;
            self.showDemandeInfo = self.isPro;
            self.showDemandeSkill = self.isPro;
            self.showDemandeOther = self.isPro;
            self.showContributionSocial = self.isPro;
            self.showContributionEvent = self.isPro;
            self.showContributionHelp = self.isPro;
            self.showContributionResource = self.isPro;
            self.showContributionInfo = self.isPro;
            self.showContributionSkill = self.isPro;
            self.showContributionOther = self.isPro;
...
- (NSArray *)toGroupedArray {
    self.categoryDictionary = @{ @"ask_for_help_social": [NSNumber numberWithBool: self.showDemandeSocial],
                                 @"ask_for_help_event": [NSNumber numberWithBool:self.showDemandeEvent],
                                 ...
                                 @"contribution_event": [NSNumber numberWithBool:self.showContributionEvent],
