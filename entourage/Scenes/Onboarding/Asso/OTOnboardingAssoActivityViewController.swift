...
class OTOnboardingAssoActivityViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        ui_label_title.text = String.init(format:  "onboard_asso_activity_title".localized,username)
        ui_label_description.text =  "onboard_asso_activity_description".localized
        
        ui_label_choice_1.text =  "onboard_asso_activity_choice_1".localized
        ui_label_choice_2.text =  "onboard_asso_activity_choice_2".localized
        ui_label_choice_3.text =  "onboard_asso_activity_choice_3".localized
        ui_label_choice_4.text =  "onboard_asso_activity_choice_4".localized
...
//        OTLogger.logEvent(View_Onboarding_Pro_Mosaic) //TODO:  Analytics
    }
