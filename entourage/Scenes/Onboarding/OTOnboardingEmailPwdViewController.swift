...
class OTOnboardingEmailPwdViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        ui_label_error.text =  "onboarding_error_email".localized
        ui_label_error.isHidden = true
        ui_label_info_mail.text =  "onboard_email_pwd_email_info2".localized
        ui_label_info_mail2.text =  "onboard_email_pwd_email_info".localized
        ui_label_title.text =  "onboard_email_pwd_title".localized
        ui_label_description.text =  "onboard_email_pwd_description".localized
        ui_label_info_pwd.text =  "onboard_email_pwd_info_length".localized
        
        ui_tf_email.placeholder =  "onboard_email_pwd_placeholder_email".localized
        ui_tf_pwd.placeholder =  "onboard_email_pwd_placeholder_pwd".localized
        ui_tf_pwd_confirm.placeholder =  "onboard_email_pwd_placeholder_confirm_pwd".localized
