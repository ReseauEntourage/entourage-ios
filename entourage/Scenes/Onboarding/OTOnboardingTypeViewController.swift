...
//        OTLogger.logEvent(View_Onboarding_Choose_Profile)//TODO:  Analytics
    }
    ...
    func prepareViews() {
        ...
        ui_label_title.text = String.init(format:  "onboard_type_title".localized, firstname)
        ui_label_description.text =  "onboard_type_sub".localized
        
        ui_label_description2.text = ""
        
        ui_label_view_1.text =  "onboard_type_choice1".localized
        ui_label_view_2.text =  "onboard_type_choice2".localized
        ui_label_view_3.text =  "onboard_type_choice3".localized
        
        ui_label_title_view_1.text =  "onboard_type_choice_title1".localized
        ui_label_title_view_2.text =  "onboard_type_choice_title2".localized
        ui_label_title_view_3.text =  "onboard_type_choice_title3".localized
    }
