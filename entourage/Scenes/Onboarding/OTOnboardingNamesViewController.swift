...
//        OTLogger.logEvent(View_Onboarding_Names)//TODO:  Analytics
    }
...
extension OTOnboardingNamesViewController: UITextFieldDelegate {
    ...
    func checkAndValidateInputs() -> Bool {
        ...
        if ui_tf_firstname.text?.count ?? 0 < minimumCharacters {
            ui_label_error.text =  "onboarding_error_firstname".localized
        }
        else {
            ui_label_error.text =  "onboarding_error_lastname".localized
        }
