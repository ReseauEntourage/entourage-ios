...
class ActionPassedOneContrib:UIViewController {
    ...
    func stylizeContentContrib() -> NSAttributedString {
        let baseString = "custom_dialog_action_content_one_contrib".localized
