...
extension ConversationListMembersViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.populateCell(isMe:isMe, username: user.username ?? "-", role: isAuthor ? "Admin".localized : "", imageUrl: user.imageUrl, showBtMessage: true,delegate: self,position: position, reactionType: nil, isConfirmed: user.confirmedAt)
        return cell
    }
