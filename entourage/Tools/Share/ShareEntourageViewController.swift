//
//  ShareEntourageViewController.swift
//  entourage
//
...
extension ShareEntourageViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "cell", for: indexPath) as! SharingEntourageTableViewCell
