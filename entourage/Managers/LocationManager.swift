...
class LocationManger:NSObject {
    ...
    func showGeolocationNotAllowedMessage(message:String? = nil, presenterVC:UIViewController? = nil) {
        ...
        alertVC.configureAlert(alertTitle: "errorSettings".localized, message: message, buttonrightType: buttonCancel, buttonLeftType: buttonValidate, titleStyle: ApplicationTheme.getFontCourantBoldOrange(), messageStyle: ApplicationTheme.getFontCourantRegularNoir(), mainviewBGColor: .white, mainviewRadius: 35, isButtonCloseHidden: true)
