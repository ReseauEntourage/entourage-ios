...
{
    [self showWithTitle:@"DialogPicker" doneButtonTitle:@"Done" cancelButtonTitle:@"Cancel" defaultDate:[NSDate date] minimumDate:nil maximumDate:nil buttonTitleColor:[UIColor blueColor] datePickerMode:UIDatePickerModeDateAndTime callback:callback];
}

-(void)showWithTitle:(NSString *)title callback:(DatePickerCallback)callback
{
    [self showWithTitle:title doneButtonTitle:@"Done" cancelButtonTitle:@"Cancel" defaultDate:[NSDate date] minimumDate:nil maximumDate:nil buttonTitleColor:[UIColor blueColor]  datePickerMode:UIDatePickerModeDateAndTime callback:callback];
}
...
-(void)showWithTitle:(NSString *)title
   ...
   cancelButtonTitle:(NSString *)cancelButtonTitle
    ...
    buttonTitleColor:(UIColor*)buttonColor
      datePickerMode:(UIDatePickerMode)datePickerMode
            callback:(DatePickerCallback)callback
{
    [self showWithTitle:title doneButtonTitle:doneButtonTitle cancelButtonTitle:cancelButtonTitle defaultDate:defaultDate minimumDate:nil maximumDate:nil buttonTitleColor:buttonColor datePickerMode:datePickerMode callback:callback];
}
