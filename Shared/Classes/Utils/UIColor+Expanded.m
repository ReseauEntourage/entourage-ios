...
- (NSArray *)arrayFromRGBAComponents
{
    ...
    return
        [NSArray arrayWithObjects:[NSNumber numberWithFloat:r], [NSNumber numberWithFloat:g], [NSNumber numberWithFloat:b], [NSNumber numberWithFloat:a], nil];
}
...
- (CGFloat)brightness
{
    NSAssert(self.canProvideRGBComponents, @"Must be an RGB color to use -value");
...
- (UIColor *)darkerColor
{
    ...
    return [UIColor colorWithCalibratedHue:self.hue saturation:self.saturation brightness:self.brightness - .2 alpha:self.alpha];
}
...
+ (UIColor *)randomColor
{
    ...
    CGFloat red = (CGFloat)random() / RAND_MAX;
    CGFloat green = (CGFloat)random() / RAND_MAX;
    CGFloat blue = (CGFloat)random() / RAND_MAX;
...
static const char *colorNameDB =
    ...
    "bargainprimary1#f78e1e,bargainprimary2#f8972b,bargainprimary3#fbb161,bargainprimary4#ffd8a7,"
    "bargainsecondary1#bf311a,bargainsecondary2#ef4135,bargainsecondary3#f48987,bargainsecondary4#fac6c7,"
    "bargaingray1#919195,bargaingray2#c9cacc,bargaingray3#ecedef,"
    "bargainmisc1#a4d7f4,bargainmisc2#a5d9c9,bargainmisc3#663700,"
    ...
    "datareefgray#cdcdcb,datareeflightgray#e4e4e2,datareefdarkgray#aaaaaa,datareefverydarkgray#6a6c6e,"
    "deeppink#ff1493,"
...
+ (NSArray *)baseColors
{
    ...
    //[a addObject:[UIColor blackColor]];
    [a addObject:[UIColor redColor]];
    [a addObject:[UIColor blueColor]];
    [a addObject:[UIColor greenColor]];
    [a addObject:[UIColor purpleColor]];
    [a addObject:[UIColor yellowColor]];
    [a addObject:[UIColor brownColor]];
    [a addObject:[UIColor orangeColor]];
...
+ (NSArray *)webColors
{
    ...
    NSString *scolors = [NSString stringWithUTF8String:colorNameDB];
    NSArray *colors = [scolors componentsSeparatedByString:@","];

    for (NSString *scolor in colors)
    {
        NSArray *parts = [scolor componentsSeparatedByString:@"#"];
        if (parts.count == 2)
        {
            UIColor *c = [UIColor colorWithHexString:[parts objectAtIndex:1]];
            [ret addObject:c];
        }
    }
