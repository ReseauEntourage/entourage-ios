...
+ (void)applyLinkOnTextView:(UITextView *)textView withText:(NSString *)text toLinkText:(NSString *)linkString withLink:(NSString *)link {
    ...
    textView.attributedText = [NSAttributedString createLinkStringFor:text linkPart:linkString font:textView.font andColor:textView.textColor withLink:link];
}
...
+ (NSAttributedString *)createLinkStringFor:(NSString *)string linkPart:(NSString *)linkPart font:(UIFont *)font andColor:(UIColor *)color withLink:(NSString *)link {
